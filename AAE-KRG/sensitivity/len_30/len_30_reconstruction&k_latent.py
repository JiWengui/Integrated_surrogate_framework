...
encoder.load_state_dict(torch.load('./result/encoder_1799model.pt'))
decoder.load_state_dict(torch.load("./result/decoder_1799model.pt"))
...
for i in range(260):
    ...
    with open('../all_data/k_laten/len_30/no_{}'.format(i), 'wb') as f:
        pickle.dump(laten, f)
