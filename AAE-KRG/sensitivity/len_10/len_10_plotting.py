...
ens_no = 260
start_num = 0
path_txt_9 = '../all_data/well_data/len_10/well_9'
...
# KRG of C1
with open('../all_data/krg_model/len_10/KRG_wel9_model.pkl', 'rb') as f:
    sm = pickle.load(f)
all_laten = []
for i in range(251):
    if i not in ti_chu:
...
# KRG of C2
with open('../all_data/krg_model/len_10/KRG_wel10_model.pkl', 'rb') as f:
    sm = pickle.load(f)
all_laten = []
for i in range(251):
    if i not in ti_chu:
...
ax0.text(0.89,14.2,'C 1', fontsize=12, color='black')
# # Subfigure 3
ax1 = fig.add_axes([.61, 0.72, .25, .23])
ax1.hist(WMAPE_9, 50)
ax1.text(0.0575,7.6,'C 1', fontsize=12, color='black')
...
ax0.set_ylabel('Frequency', fontsize=11, labelpad=-4)
ax0.set_yticks([0,3,6,9,12,15])
ax0.text(0.9715,16.1,'C 2', fontsize=12, color='black')
# # Subfigure 6
ax1 = fig.add_axes([.61, 0.43, .25, .23])
ax1.hist(WMAPE_10, 50)
ax1.text(0.037,7.6,'C 2', fontsize=12, color='black')
ax1.set_ylabel('Frequency', fontsize=11, labelpad=0)
ax1.set_xlabel('WMAPE', fontsize=11)

plt.savefig('./figuer_len10.png', dpi=500)
