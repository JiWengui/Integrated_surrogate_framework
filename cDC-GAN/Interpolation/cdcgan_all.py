...
time_point = ['15', '102', '152','251','300','450','650']
# time_point = ['15', '102', '201', '251', '350', '551']
...
for epoch in range(opt.n_epochs):
    for i, imgs in enumerate(x_train):
        ...
        # if (epoch + 1) % 25 == 0 and i == 599:
        #     torch.save(generator.state_dict(), './result/201d/G_{}model.pt'.format(epoch))  # 模型保存
        #     a = 0
        # # 251天
        ...
        # if (epoch + 1) % 25 == 0 and i == 999:
        #     torch.save(generator.state_dict(), './result/350d/G_{}model.pt'.format(epoch))  # 模型保存
        # 450天
        ...
        # if (epoch + 1) % 25 == 0 and i == 1199:
        #     torch.save(generator.state_dict(), './result/551d/G_{}model.pt'.format(epoch))  # 模型保存
        #     aa = 0
        # 650天
